...
// Source: terp-rs/src/gen/ibc.core.commitment.v2.rs
...
export const MerklePathSchema = z.object({
  key_path: z.array(z.string()),
});
export type MerklePath = z.infer<typeof MerklePathSchema>;


// ── Package metadata ──────────────────────────────────────────
export const PACKAGE = 'ibc.core.commitment.v2' as const;
