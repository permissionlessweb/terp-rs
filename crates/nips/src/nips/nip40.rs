// // NIP-40: TIMESTAMPS - https://github.com/nostr-protocol/nips/blob/master/40.md
// // implemented by default in signed msgs, can set expiration with either `with_expiration` `nip40`
// // need to implement interface between cosmwasm timestamp and nostr timestamp here
