...
## Headstash Factory Contract

The Headstash Factory Contract provides a centralized mechanism for deploying and managing multiple headstash instances, enabling scalable privacy-preserving distribution across different campaigns and token strategies.
