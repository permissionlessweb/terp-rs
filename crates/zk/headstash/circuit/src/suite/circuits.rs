//! Test circuits for the headstash system.
//!
//! This module provides spec-compliant test circuits that can be used for:
//! - Testing circuit implementations with MockProver
//! - Generating proving/verification keys
//! - Integration testing with the suite's test data builders
