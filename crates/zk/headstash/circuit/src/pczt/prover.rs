        ...
        let circuits = self
            ...
            .map(|action| {
                ...
                let note = Note::from_parts(
                    action.spend.nd.ok_or(ProverError::MissingRecipient)?,
                    action.spend.value.ok_or(ProverError::MissingRecipient)?,
                    action.spend.fdi.ok_or(ProverError::MissingRecipient)?,
                    action
                        .spend
                        .recipient
                        .ok_or(ProverError::MissingRecipient)?,
                    action.spend.esk.ok_or(ProverError::MissingRecipient)?,
                ...
                let output_note = Note::from_parts(
                    action.output.nd.ok_or(ProverError::MissingRecipient)?,
                    action.output.v.ok_or(ProverError::MissingValue)?,
                    action.output.fdi.ok_or(ProverError::MissingValue)?,
                    action
                        .output
                        .recipient
                        .ok_or(ProverError::MissingRecipient)?,
                    action.output.esk.ok_or(ProverError::MissingRecipient)?,
