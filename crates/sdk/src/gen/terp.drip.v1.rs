...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.GenesisState".into()
    }
...
impl ::prost::Name for MsgDistributeTokens {
    const NAME: &'static str = "MsgDistributeTokens";
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.MsgDistributeTokens".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.MsgDistributeTokens".into()
    }
...
impl ::prost::Name for MsgDistributeTokensResponse {
    const NAME: &'static str = "MsgDistributeTokensResponse";
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.MsgDistributeTokensResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.MsgDistributeTokensResponse".into()
    }
...
impl ::prost::Name for MsgUpdateParams {
    ...
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.MsgUpdateParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.MsgUpdateParams".into()
    }
...
impl ::prost::Name for MsgUpdateParamsResponse {
    ...
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.MsgUpdateParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.MsgUpdateParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn distribute_tokens(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgDistributeTokens>,
        ) -> std::result::Result<
            tonic::Response<super::MsgDistributeTokensResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/terp.drip.v1.Msg/DistributeTokens",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("terp.drip.v1.Msg", "DistributeTokens"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/terp.drip.v1.Msg/UpdateParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("terp.drip.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod msg_server {
    ...
    pub trait Msg: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn distribute_tokens(
            &self,
            request: tonic::Request<super::MsgDistributeTokens>,
        ) -> std::result::Result<
            tonic::Response<super::MsgDistributeTokensResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/terp.drip.v1.Msg/DistributeTokens" => {
                    ...
                    struct DistributeTokensSvc<T: Msg>(pub Arc<T>);
                    impl<T: Msg> tonic::server::UnaryService<super::MsgDistributeTokens>
                    for DistributeTokensSvc<T> {
                        type Response = super::MsgDistributeTokensResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Msg>::distribute_tokens(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = DistributeTokensSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "terp.drip.v1.Msg";
...
impl ::prost::Name for QueryParamsRequest {
    ...
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.QueryParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.QueryParamsRequest".into()
    }
...
impl ::prost::Name for QueryParamsResponse {
    ...
    const PACKAGE: &'static str = "terp.drip.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "terp.drip.v1.QueryParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/terp.drip.v1.QueryParamsResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/terp.drip.v1.Query/Params",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("terp.drip.v1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "terp.drip.v1.Query";
