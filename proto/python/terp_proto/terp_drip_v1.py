...
# Source: terp-rs/proto/src/gen/terp.drip.v1.rs
...
class GenesisState:
    ...
    TYPE_URL: str = field(default="/terp.drip.v1.GenesisState", init=False, repr=False)
...
class Params:
    ...
    TYPE_URL: str = field(default="/terp.drip.v1.Params", init=False, repr=False)
...
class MsgDistributeTokens:
    ...
    amount: List[Any] = field(default_factory=list)
    TYPE_URL: str = field(default="/terp.drip.v1.MsgDistributeTokens", init=False, repr=False)
    ...
    @classmethod
    def decode(cls, data: bytes) -> "MsgDistributeTokens":
        """Decode from protobuf binary (requires native extension)."""
        from terp_proto._native import decode_message  # type: ignore[import]
        return cls(**json.loads(decode_message(cls.TYPE_URL, data)))
...
@dataclass
class MsgDistributeTokensResponse:
    """MsgDistributeTokensResponse defines the MsgDistributeTokens response type"""
    TYPE_URL: str = field(default="/terp.drip.v1.MsgDistributeTokensResponse", init=False, repr=False)
    ...
    @classmethod
    def decode(cls, data: bytes) -> "MsgDistributeTokensResponse":
        """Decode from protobuf binary (requires native extension)."""
        from terp_proto._native import decode_message  # type: ignore[import]
        return cls(**json.loads(decode_message(cls.TYPE_URL, data)))
...
class MsgUpdateParams:
    ...
    params: Optional[Params] = None
    TYPE_URL: str = field(default="/terp.drip.v1.MsgUpdateParams", init=False, repr=False)
...
class MsgUpdateParamsResponse:
    TYPE_URL: str = field(default="/terp.drip.v1.MsgUpdateParamsResponse", init=False, repr=False)
...
class QueryParamsRequest:
    ...
    TYPE_URL: str = field(default="/terp.drip.v1.QueryParamsRequest", init=False, repr=False)
...
class QueryParamsResponse:
    ...
    params: Optional[Params] = None
    TYPE_URL: str = field(default="/terp.drip.v1.QueryParamsResponse", init=False, repr=False)
